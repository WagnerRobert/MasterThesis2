...
for location in locKmerList:
    ...
    for protein in locKmerList[location]:
        ...
        print "\t\t" +'%.2f' % str(math.fsum(prosite_coverage_list)/float(len(prosite_coverage_list))) + "\t" + '%.2f' % str(math.fsum(no_prosite_coverage_list)/float(len(no_prosite_coverage_list))) + "\t" + str( len(prosite_coverage_list)) + "\t" + str( len(no_prosite_coverage_list))
