...
#reader.read_kmerfiles(paths, quant) #reads and prepares kmerweights files, saves complete result (dict[svm][protein]) kmers.pkl in pickles dir
...
#         print "\t" + protein
#         for kmer in kmerlist[svm][protein][0]:
#             print "\t\t" + str(kmer)
